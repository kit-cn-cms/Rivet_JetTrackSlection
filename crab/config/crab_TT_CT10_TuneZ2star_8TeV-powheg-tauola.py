...
config.General.requestName = 'MC_Powheg_TT_CT10_TuneZ2star_8TeV'
...
config.Data.inputDataset = '/TT_CT10_TuneZ2star_8TeV-powheg-tauola/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM'
