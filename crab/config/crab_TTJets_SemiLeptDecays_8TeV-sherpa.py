...
config.General.requestName = 'MC_Sherpa_TTJets_SemiLeptDecays_8TeV'
...
config.Data.inputDataset = '/TTJets_SemiLeptDecays_8TeV-sherpa/Summer12_DR53X-PU_S10_START53_V19-v1/AODSIM'
